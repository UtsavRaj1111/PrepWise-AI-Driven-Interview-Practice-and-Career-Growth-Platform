...
def migrate():
    ...
    csv_path = os.path.join(os.path.dirname(__file__), 'para_jumbles_questions.csv')
    ...
    if questions:
        # Cleanup first
        print("Cleaning up old para_jumbles questions...")
        handler._safe_execute(handler.client.table("questions").delete().eq("category", "para_jumbles"))
